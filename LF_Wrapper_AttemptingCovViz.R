...
save_mbg_input(indicator = indicator, 
               ...
               mesh_s = mesh_s,
               mesh_t = mesh_t, 
               cov_list = list(unlist(stacked_rasters), unlist(all_cov_layers)))
...
shiny_cov_layers(fixed_effects = paste(names(list(unlist(stacked_rasters), unlist(all_cov_layers))),collapse = " + "),
                 gaul_list = gaul_list,
                 run_date = run_date,
                 indicator = indicator,
                 indicator_group = indicator_group)
